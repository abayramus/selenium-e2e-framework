...
#    Given kullanici "https://managementonschools.com/" sayfasina
...
#    And dean name kutusuna "ahasdgat" girer
#    And dean surname kutusuna "basdgasdm" girer
#    And birthplace kutusuna "fsadgasd"
#    And gender olarak "male"
